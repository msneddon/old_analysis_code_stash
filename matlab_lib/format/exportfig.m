...
%
%   This function was downloaded from the MathWorks 'Matlab Digest'
%   newsletter and has been edited by Michael Sneddon to accept higher
%   quality jpeg images.
...
for k = 1:2:length(paramPairs)
  ...
  switch (param)
   case 'format'
    format = value;
    if (~strcmp(format,{'eps','eps2','jpeg','png','preview','jpeg100'}))
